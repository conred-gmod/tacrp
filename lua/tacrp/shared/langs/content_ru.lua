...
L["wep." .. w .. ".desc.quote"] = "\"Куда все ушли? В киношку?\""
L["wep." .. w .. ".trivia.manufacturer"] = "Heckler & Koch"
...
L["wep." .. w .. ".trivia.manufacturer"] = "Heckler & Koch"
L["wep." .. w .. ".credits"] = "Модель: Twinke Masta \nТекстуры: Thanez \nАнимации: Tactical Intervention, редактированы speedonerd"

w = ws .. "mp5sd"
L["wep." .. w .. ".name.full"] = "HK MP5SD6"
L["wep." .. w .. ".name"] = "MP5SD6"
L["wep." .. w .. ".desc"] = "Культовый пистолет-пулемёт с интегрированным глушителем. Малая дальность и отдача, но трайсера незаметны."
L["wep." .. w .. ".desc.quote"] = "\"Свобода пушкам.\""
L["wep." .. w .. ".trivia.manufacturer"] = "Heckler & Koch"
L["wep." .. w .. ".credits"] = "Модель: Twinke Masta \nТекстуры: Geno & Mr. Brightside \nЗвуки: Lakedown, Teh Sterlok \nАнимации: Tactical Intervention, редактрованы speedonerd"
...
L["wep." .. w .. ".trivia.manufacturer"] = "SIG Sauer AG"
L["wep." .. w .. ".credits"] = "Ассеты: Contract Wars \nБыло портированно в CS 1.6 by GR_Lucia \nАнимация: Tactical Intervention"
...
L["wep." .. w .. ".name"] = "P99"
L["wep." .. w .. ".desc"] = "Сбалансированный пистолет с высокой скоростью стрельбы."
...
L["wep." .. w .. ".name"] = "PSG-1"
L["wep." .. w .. ".desc"] = "Элегантная полуавтоматическая стрелковая винтовка с непревзойдённой точностью и контролем отдачи. Оснащён 8-кратным оптическим прицелом."
...
L["wep." .. w .. ".name"] = "SCAR-L"
L["wep." .. w .. ".desc"] = "Современная, лёгкая штурмовая винтовка с умеренной скорострельностью"
L["wep." .. w .. ".trivia.manufacturer"] = "FN Herstal"
L["wep." .. w .. ".credits"] = "Ассеты: Counter-Strike: Online 2"

w = ws .. "scout"
L["wep." .. w .. ".name"] = "Steyr Scout"
L["wep." .. w .. ".desc"] = "Лёгкая винтовка, рассчитанная скорее на портативность и комфорт, чем на прямую огневую мощь. Имеет встроенные сошки.\nОснащён 6-кратным оптическим прицелом."
...
L["wep." .. w .. ".desc"] = "Тяжёлый магазинный приёмник культового двухрежимного дробовика. Низкая отдача, но не очень высокая точность."
