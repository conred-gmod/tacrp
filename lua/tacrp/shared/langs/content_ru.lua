...
L["wep." .. w .. ".desc"] = "Простая в обращении винтовка с низкой скоростью стрельбы и отдачей."
...
L["wep." .. w .. ".name"] = "AS50"
L["wep." .. w .. ".desc"] = "Полуавтоматическая крупнокалиберная винтовка, способная легко уничтожить любого человека на любом расстоянии. \nОснащён 12-кратным оптическим прицелом. \nСлишком тяжёлая для размаха, так что о ударе прикладом не может быть и речи."
...
L["wep." .. w .. ".name"] = "AUG A2"
L["wep." .. w .. ".desc"] = "Скорострельная винтовка схемы буллпап с большим объёмом магазина и отличной эргономичностью."
L["wep." .. w .. ".trivia.manufacturer"] = "Steyr Arms"
L["wep." .. w .. ".credits"] = "Ассеты: Tactical Intervention"

w = ws .. "bekas"
L["wep." .. w .. ".name.full"] = "Молот Бекас-16М"
...
L["wep." .. w .. ".desc"] = "Полимерный пистолет с большей чем у стандартных мощностью и высокой скорострельностью."
...
L["wep." .. w .. ".desc"] = "Тяжелая крупнокалиберная винтовка, способная убить одним выстрелом. \nОснащён 12-кратным оптическим прицелом. \nДостаточно лёгкая для замаха прикладом."
...
L["wep." .. w .. ".name"] = "HK45C"
L["wep." .. w .. ".desc"] = "Современный крупнокалиберный пистолет с большой огневой мощью и в удобном комплекте."
L["wep." .. w .. ".trivia.manufacturer"] = "Heckler & Koch"
...
L["wep." .. w .. ".name"] = "MP9"
L["wep." .. w .. ".desc"] = "Компактный полимерный пистолет-пулемет, обладающий большой огневой мощью в небольшом комплекте."
...
L["wep." .. w .. ".desc"] = "Самоуправляемая зенитно-ракетная установка. Высокий урон от взрыва, но не по технике. \nТребуется зафиксировать цель для выстрела."
...
L["wep." .. w .. ".name"] = "UMP45"
L["wep." .. w .. ".desc"] = "Квадратенький пистолет-пулемёт, был разработан с учётом низких производственных затрат. \nВысокий урон вблизи, но дальность и скорострельность низкие."
L["wep." .. w .. ".desc.quote"] = "\"Что это за хуёвые, дымящиеся пушки?\""
L["wep." .. w .. ".trivia.manufacturer"] = "Heckler & Koch"
...
L["wep." .. w .. ".credits"] = "Ассеты: Tactical Intervention (Unused)"
...
L["wep." .. w .. ".name"] = "AK-12"
L["wep." .. w .. ".desc"] = "One of many attempts at modernizing the AK, this experimental Модель uses burst fire and allows for quick swapping of the weapon's caliber."
...
L["wep." .. w .. ".name"] = "ACR"
L["wep." .. w .. ".desc"] = "Гражданская винтовка, представленная в качестве альтернативы другим популярным платформам. Сбалансированная винтовка, которая приспособленна для различных современных калибров."
...
L["wep." .. w .. ".name"] = "AUG A1"
L["wep." .. w .. ".desc"] = "Классический вариант AUG с увеличенным магазином и автоматическим режимом огня.\nОснащен фиксированным 1,5-кратным оптическим прицелом и механическим прицелом."
L["wep." .. w .. ".desc.quote"] = "\"Я хочу крови!\" \"И ты ее получишь!\""
L["wep." .. w .. ".trivia.manufacturer"] = "Steyr Arms"
...
L["wep." .. w .. ".name"] = "F2000"
L["wep." .. w .. ".desc"] = "Карабин булл-пап с высокой скорострельностью и мобильностью, но обладает нестабильной отдачей из-за необычной эргономики.\nПо умолчанию оснащен 1,6-кратным прицелом."
...
L["wep." .. w .. ".desc"] = "Прототип автоматического дробовика булл-пап с высокой точностью и бронепробиваемостью.\nОснащен фиксированным прицелом 1,5х."
...
L["wep." .. w .. ".desc"] = "Японская боевая винтовка, стреляющая специальным патроном с уменьшенной нагрузкой. Обладает значительным весом, но удобен в использовании."
L["wep." .. w .. ".desc.quote"] = "\"Прист-21, это Тревор. Приготовиться к стрелбе. Убить Виверну.\""
...
L["wep." .. w .. ".name"] = "Mk 22"
L["wep." .. w .. ".desc"] = "Старый пистолет для спецназа, предназначенный для секретных операций."
...
L["wep." .. w .. ".desc"] = "Прочный 9 мм пистолет, обладающий высокой мобильностью и высокой скорострельностью. \nПродавался под названием \"Baby Eagle\" за внешнее сходство с Desert Eagle."
...
L["wep." .. w .. ".name"] = "L85A2"
L["wep." .. w .. ".desc"] = "Британская винтовка булл-пап, имеющая средние характеристики и известные проблемы с надежностью.\nПо умолчанию оснащен 3-кратным прицелом."
...
L["wep." .. w .. ".name"] = "M29"
L["wep." .. w .. ".desc"] = "Кастомный револьвер «магнум» с тяжелым курком, но обладает большим уроном на расстоянии."
...
L["wep." .. w .. ".name"] = "M733"
L["wep." .. w .. ".desc"] = "AR-15 с уменьшенной длиной ствола, но обладает высокой трудноконтролируемой скорострельностью. Фиксированная рукоятка ограничивает возможности установки оптики."
...
L["wep." .. w .. ".name"] = "Masada"
L["wep." .. w .. ".desc"] = "Современная винтовка с облегченной полимерной конструкцией."
...
L["wep." .. w .. ".desc"] = "Боевая винтовка, предназначенная для нескольких ролей пехоты. Специализированные патроны обладают высокой бронепробитием и сохраняют урон на дистанции."
...
L["wep." .. w .. ".desc"] = "Современный короткоствольный револьер с шестиугольным цилиндром. Малый калибр и малокалиберный ствол делают эту пушку легкой и быстрой в использовании."
...
L["wep." .. w .. ".desc"] = "Легкая винтовка, рассчитанная скорее на портативность и комфорт, чем на прямую огневую мощь. Имеет встроенные сошки.\nПо умолчанию оснащен 6-кратным прицелом."
...
L["wep." .. w .. ".name"] = "M1873"
L["wep." .. w .. ".desc"] = "Культовая винтовка, ставшая олицетворением ковбоев, до сих пор пользуется популярностью среди гражданских стрелков. Стрельба из нее доставляет массу удовольствия, но она сильно уступает большинству современных видов оружия."
...
w = ws .. "sw686"
L["wep." .. w .. ".name.full"] = "SW Модель 686"
...
L["wep." .. w .. ".trivia.manufacturer"] = "Heckler & Koch"
L["wep." .. w .. ".credits"] = "Custom built by speedonerd for Valence \nOriginal Модель: Thanez, Racer445, fxdarkloki \nAdditional Ассеты: Battlestate Games, Crytek \nЗвуки: Vunsunta, BlitzBoaR"
...
L["wep." .. w .. ".trivia.manufacturer"] = "Knight's Armament"
L["wep." .. w .. ".credits"] = "Custom built by speedonerd for Bladelordomega \nSR-25: Firearms: Источник \nAdditional Ассеты: Battlestate Games, Treyarch, Crytek, kriboez, cR45h"
