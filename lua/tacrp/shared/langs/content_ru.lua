...
L["wep." .. w .. ".desc"] = "Лёгкая штурмовая винтовка с интегрированным глушителем. Эффективная в узких помещениях и скрывает след пули, но плохо показывает себя на расстоянии."
...
L["wep." .. w .. ".desc"] = "Однозарядный охотничий пистолет. Точный, компактный и убойный, и тебе лучше не промахиваться. По умолчанию оснащён 6-кратным прицелом."
...
L["wep." .. w .. ".desc"] = "Пара золотистых Desert Eagles, как будто одного было недостаточно. \nВ два раза больше безумного урона и отдачи."
...
L["wep." .. w .. ".desc"] = "Пара автоматических Микро Узи. Не знаю как ты попадешь в цель с таким набором, но, думаю, ты справишься."
...
L["wep." .. w .. ".desc.quote"] = "\"Я отпустил палец с курка, и все было кончено.\""
L["wep." .. w .. ".trivia.manufacturer"] = "Pietro Beretta"
L["wep." .. w .. ".credits"] = "Модель: Spydr \nТекстуры: NCFurious \nАнимации: Tactical Intervention"

w = ws .. "famas"
L["wep." .. w .. ".name"] = "FAMAS F1"
L["wep." .. w .. ".desc"] = "Булл-пап французкой армии стреляющий очередями. Высокая скорострельность и точность, но малая ёмкость магазина и сильная отдача. Оснащён сошками по эзотерическим французким причинам."
...
L["wep." .. w .. ".name"] = "MP40"
L["wep." .. w .. ".desc"] = "Пистолет-пулемёт Второй Мировой Войны, с низкой скорострельностью и отдачей. Несмотря на её возраст, она досихпор появляется в зонах боевых действий."
...
L["wep." .. w .. ".desc.quote"] = "\"Шокирующе. Это и правда шокирует.\""
L["wep." .. w .. ".trivia.manufacturer"] = "Walther"
L["wep." .. w .. ".credits"] = "Модель и текстуры: Kimono \nЗвуки: HK & Vunsunta \nАнимации: Tactical Intervention, edited by speedonerd"
