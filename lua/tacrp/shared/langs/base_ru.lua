...
L["stat.raw_dps.desc"] = "Расчитанное время убийства оружием без снижения урона.\nНе учитываются множители урона по частям тела или бронепробитие."
...
L["stat.recoilkick"] = "Отдача выстрела"
...
L["stat.recoilfirstshot"] = "Начало множителя"
...
L["stat.scopedsway"] = "Пошатывание прицела"
...
L["stat.melee2attacktime.desc"] = "Количество времени между каждым тяжёлой ударом, если во что-то попасть."
...
L["stat.zoom"] = "Пошатывание в прицеле"
L["stat.bloomintensity"] = "Больший множитель"

L["att.none"] = "N/A"

L["att.procon.3proj"] = "Три снаряда"
L["att.procon.moreproj"] = "Много снарядов"
...
L["att.procon.quickthrow"] = "Жанглирование гранатами"
L["att.procon.throwrocks"] = "Бросить камнями"
L["att.procon.cornershot"] = "Камера при стрельбе вслепую"
L["att.procon.thermal"] = "Камеры при выглядывании из прицела"
